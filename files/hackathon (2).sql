...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2023 at 09:52 AM
...
(1, 'Web DevelopmentSSSS', '2023-05-11 06:03:38'),
(2, 'System Development', '2023-05-11 05:23:03'),
(3, 'Dev Ops', '2023-05-11 05:58:23'),
(5, 'fdsfsffsd', '2023-05-11 06:18:55');
...
INSERT INTO `lessons` (`lesson_id`, `mentor_id`, `title`, `content`, `file`, `date_created`) VALUES
(7, 3, 'C#', 'this is very basic go to this link hahaha :D', '../files/hackathon (1).sql', '2023-05-11 07:44:45');
...
INSERT INTO `mentor` (`mentor_id`, `firstname`, `lastname`, `middlename`, `age`, `email`, `contact_number`, `department_id`, `date_created`, `username`, `password`) VALUES
(3, 'Neil', 'dada', '', 0, '12121@gmail.com', '21212', 2, '2023-05-11 05:46:42', 'mentor', 'mentor'),
(4, 'ewfsfsd', 'sfdsfds', 'fdsf', 0, 'fdsfsfd@gmail.com', '121212121', 1, '2023-05-11 05:46:57', 'chill', 'chill');
...
(1, 'UC-MAIN Campus', '2023-05-10 16:00:00'),
(2, 'UC-BANILAD campus', '2023-05-11 05:21:09');
...
--
ALTER TABLE `lessons`
  ADD CONSTRAINT `fk1` FOREIGN KEY (`mentor_id`) REFERENCES `mentor` (`mentor_id`);
