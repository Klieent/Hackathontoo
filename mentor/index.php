                  ...
                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="main-body">
                      <div class="card shadow ">
                        <div class="card-body">
                          <h3 class="mb-0 mt-3"><u>{Lessons name}</u></h3>
                          <br>
                          <p>
                        ...
                        <!-- <div class=" mt-2 p-3 rounded " style="border-color:black; border-style: solid; border-left:none; border-right:none; width:99%; margin:auto;">
                          <div class="comment row pl-3 mb-2">
                            ...
                            <div class=" text-start pr-3" style="width:85%;">
                              <p class="h5">{intern name}</p>
                              <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor </p>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="card shadow mb-3">
                        <div class="card-body row">
                          <div class="col">
                            <input type="text" id="simpleinput" class="form-control" placeholder="Add comment">
                          </div>
                          <div class="col-2">
