...
if(isset($_POST['addIntern'])){
    ...
    $fields = array('firstname','lastname','middlename','birthdate','address','contact_number','email','school','username','password');
...
if(isset($_POST['editIntern'])){
    ...
    $fields = array('intern_id','firstname','lastname','middlename','birthdate','address','contact_number','email','school');
